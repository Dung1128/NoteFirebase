...
@connect(
  ...
  { ...commonActions, ...notificationActions, ...noteActions }
)
export default class extends Component {
  ...
  renderHeaderBack(title) {
    ...
    const center = (
      <Title style={{ alignSelf: 'center' }} full>
        {title}
      </Title>
    );
      ...
      <View>
        {title === 'Details' ? (
          <Button
            transparent
            onPress={() => {
              this.props.forwardTo('addNote');
              this.props.actionUpdate(true);
            }}
          >
  ...
  renderHeaderHome(title) {
    ...
    const center = (
      <Title white style={{ alignSelf: 'center' }}>
        {this.props.getActionUpdate ? 'Update' : title}
      </Title>
    );
    const right = (
